...
public class EntityV2 {
    ...
    public EntityV2(){}
    public EntityV2(float x, float y){
        mX = x;
        mY = y;
    }
    ...
    public boolean isColliding(EntityV2 that){
        return EntityV2.intersectsAABB(this, that);
    }
    ...
    public static boolean intersectsAABB(EntityV2 a, EntityV2 b) {
