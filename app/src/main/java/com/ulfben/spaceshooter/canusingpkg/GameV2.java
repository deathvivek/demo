...
import com.ulfben.spaceshooter.JukeBox;
import com.ulfben.spaceshooter.Player;
import com.ulfben.spaceshooter.Star;

import java.util.ArrayList;

public class GameV2 extends SurfaceView implements Runnable{
    ...
    private ArrayList<EntityV2> mEntities = new ArrayList<>();
    private PlayerV2 mPlayer;
    ...
    public GameV2(final Context context){
        super(context);
        ...
        //    mEntities.add(new StarV2());
        }
        for(int i = 0; i < ENEMY_COUNT; i++){
            mEntities.add(new EnemyV2(context));
        }
        mPlayer = new PlayerV2(context);
    ...
    private void startGame(){
        mPlayer.respawn();
        for(final EntityV2 e : mEntities){
            e.respawn();
        }
        mGameOver = false;
        mDistanceTraveled = 0;
